...
import { FaCss3, FaHtml5, FaSass, FaJs, FaPhp, FaPython, FaWordpress, FaCloudflare, FaGit } from "react-icons/fa";
import { DiMysql } from "react-icons/di";
import { SiSqlite, SiVercel } from "react-icons/si";
        ...
        <div>
            ...
            >
                <div className="flex items-start justify-center pt-32 pb-16">
                    <div className="flex flex-col md:flex-row items-center gap-6 md:gap-10 translate-y-4">
